...
client = spotinst_sdk.SpotinstClient(auth_token="YOUR_API_TOKEN_HERE")

# Initialize application
application = spotinst_sdk.spotinst_functions.Application("my_great_application")
...
environment = spotinst_sdk.spotinst_functions.Environment("testings", app_id, providers, locations)
...
# Initialize function
function = spotinst_sdk.spotinst_functions.Function("ping", env_id, '/development/my_project/ping', 'main',
                                                    'nodejs48', 256, 30)
