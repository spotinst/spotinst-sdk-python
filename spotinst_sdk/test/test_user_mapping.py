...
from spotinst_sdk.spotinst_user_mapping import *
...
class AwsElastigroupTestCase(unittest.TestCase):
    ...
    def load_mapping_json():
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'test_lib/input/user_mapping.json')) as group_json:
