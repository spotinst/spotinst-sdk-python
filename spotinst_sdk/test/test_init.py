...
class AwsInitTestOcean(AwsInitTestCase):
	...
	def testCreateOcean(self, mock):
		mock_cluster_response = self.load_json('test_lib/output/ocean_cluster_res.json')
		mock_cluster_json = self.load_json('test_lib/input/ocean_cluster.json')
	...
	def testGetAllOcean(self, mock):
		mock_get_ocean_clusters_res    = self.load_json('test_lib/output/get_ocean_clusters_res.json')
