...
from spotinst_sdk.spotinst_blue_green_deployment import *
...
class AwsElastigroupTestCase(unittest.TestCase):
    ...
    @staticmethod
    def load_group_json():
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'test_lib/input/bg_deployment.json')) as group_json:
