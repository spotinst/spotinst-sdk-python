...
from spotinst_sdk.spotinst_ocean import *
...
class SpotinstOceanTestCase(unittest.TestCase):
    ...
    @staticmethod
    def load_ocean_json():
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'test_lib/input/ocean_cluster.json')) as cluster_json:
