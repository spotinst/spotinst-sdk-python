...
class McsClient(Client):
    ...
    def get_kubernetes_cluster_cost(self, cluster_id, from_date, to_date):
        """
        ...
        result = self.send_get(
            [self.__base_kube_url, cluster_id, "costs"], query_params=query_params, entity_name='kubernetes')
